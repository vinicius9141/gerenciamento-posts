...
import { getAllClients, createPost } from "@/lib/firebase"
...
export default function NewPost() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!imageFile || !date || !selectedCalendar) {
        return
      }
      ...
      toast({
        title: "Post agendado",
        description: "O post foi agendado com sucesso!",
      })

      router.push("/admin/posts")
    } catch (error: any) {
      console.error("Error scheduling post:", error)
      let errorMessage = "Erro ao agendar o post"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container py-8">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight ml-4">Novo Post</h1>
        </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Preencha os detalhes do post a ser agendado</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Faça upload da imagem para o post (máximo 2MB)</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
